...
리스트 변수
- 하나의 변수에 여러 개의 값을 저장할 수 있는 변수 리스트 변수
...
- 우선순위를 지정하기 위해 괄호를 사용하려면 \처리 해줘야 한다.
- 곱셈 문자는 \* 사용

2. $(( ))

+ read 명령어 : 스크립트 문 실행을 통해서 입력을 받아 처리 할때 주로 사용한다.

quiz
두 수를 입력받아 사칙연산을 수행하는 프로그램을 쉘스크립트로 작성하세요
