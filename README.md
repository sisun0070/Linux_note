...
3. 버전관리
: ㅇ특정 패키지의 버전을 명확하게 지정하고 관리할 수 있다.
...
2. rwxr-xr-x (그 다음 글자)
 r : read의 약자, 파일에 대한 읽기 권한
 w : write의 약자, 파일에 대한 쓰기 권한
 x : 파일에 대한 실행 권한
 - : 권한이 없음 !

접근권한이란?
: 파일으 접근권한은 읽기 쓰기 실행 권한을 의미하는데 읽기 쓰기 실행 권한은 대상 파일의 종류에 따라 다른 의미를 갖는다. 
